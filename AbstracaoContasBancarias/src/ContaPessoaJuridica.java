public class ContaPessoaJuridica extends Conta{
    ...
    public ContaPessoaJuridica(int numero, int agencia, String titular, double saldo, String titular1, double saldo1) {
    ...
    public void calcularTarifaMensal() {
        ...
        IO.println("Está conta tem uma tarifa de R$20,00 ");
